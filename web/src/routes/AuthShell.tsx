    ...
    <div className="flex min-h-dvh items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm animate-slide-up">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-flame-500/15 text-flame-500">
        ...
        <p className="mt-6 text-center text-xs text-ink-600">75 Hard · 75 days, no compromises</p>
      </div>
    </div>
  )
}

/** Provider buttons, rendered only for the providers the server has configured. */
  ...
  return (
    <>
      ...
      <div className="space-y-3">
        {config.google && (
          // A full page navigation, not fetch: the OAuth dance ends in a
...
function GoogleMark() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden>
      ...
      <path fill="#EA4335" d="M12 4.8c1.7 0 3.2.6 4.4 1.7l3.3-3.3C17.7 1.2 15.1 0 12 0 7.6 0 3.7 2.6 1.8 6.2l3.8 3C6.5 6.7 9 4.8 12 4.8Z" />
    </svg>
  )
}
